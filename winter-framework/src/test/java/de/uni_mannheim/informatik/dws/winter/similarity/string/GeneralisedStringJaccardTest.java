...
public class GeneralisedStringJaccardTest extends TestCase {
	...
	/**
	 * Test method for {@link GeneralisedStringJaccard#calculate(String, String)}.
	 */
	public void testCalculateStringString() {
		...
		GeneralisedStringJaccard sim = new GeneralisedStringJaccard(new TokenizingJaccardSimilarity(), 0.5, 0.0);
		...
		assertEquals(1.0/3.0, sim.calculate(s2, s3));
		assertEquals(1.0/3.0, sim.calculate(s3, s2));
