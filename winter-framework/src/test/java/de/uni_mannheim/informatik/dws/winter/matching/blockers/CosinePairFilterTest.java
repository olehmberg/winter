 ...
 *
 */
public class CosinePairFilterTest extends TestCase {

	/**
	 * Test method for {@link de.uni_mannheim.informatik.dws.winter.matching.blockers.CosinePairFilter#createFinalPair(de.uni_mannheim.informatik.dws.winter.model.Correspondence, java.util.Set, java.util.Set)}.
	 */
	public void testCreateFinalPair() {
		...
		CosinePairFilter<Attribute, MatchableValue> pairFilter = new CosinePairFilter<>(0.0);
