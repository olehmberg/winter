...
/**
 * {@link TokenGenerator} for {@link Product}s, which generates
 * tokens based on the description split by white space.
 * 
 * @author Alexander Brinkmann (alex.brinkmann@informatik.uni-mannheim.de)
 * 
 */
public class ProductTokenGeneratorByDescription extends
	...
	public void generateTokens(Product record, Processable<Correspondence<Attribute, Matchable>> correspondences, DataIterator<Pair<String, Product>> resultCollector) {
		String[] descriptionTokens = tokenizeString(record.getDescription());
