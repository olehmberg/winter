...
/**
 * {@link Comparator} for {@link Product}s based on the {@link Product#getTitle()}
 * value and their TF-IDF & Cosine Similarity value.
 * 
 * @author Alexander Brinkmann (alex.brinkmann@informatik.uni-mannheim.de)
 * 
 */
public class ProductTitleComparatorTFIDFCosine implements Comparator<Product, Attribute> {
	...
	public ProductTitleComparatorTFIDFCosine(HashedDataSet<Product, Attribute> dataProductsLeft,
