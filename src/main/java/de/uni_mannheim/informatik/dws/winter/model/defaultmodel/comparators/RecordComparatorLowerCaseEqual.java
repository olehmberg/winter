 ...
 * exactly matching after the string is converted to lower case.
 * 
 * @author Alexander Brinkmann (albrinkm@mail.uni-mannheim.de)
 * 
 */
public class RecordComparatorLowerCaseEqual extends RecordComparator {

	public RecordComparatorLowerCaseEqual(Attribute attributeRecord1, Attribute attributeRecord2) {
