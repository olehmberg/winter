 ...
 *
 */
public class AttributeValueGenerator extends BlockingKeyGenerator<Record, MatchableValue, Attribute> {

	private static final long serialVersionUID = 1L;
	DataSet<Attribute, Attribute> schema;
	
	public AttributeValueGenerator(DataSet<Attribute, Attribute> schema) {
		this.schema = schema;
	}
	...
	public void mapRecordToKey(Pair<Record, Processable<SimpleCorrespondence<MatchableValue>>> pair,
			DatasetIterator<Pair<String, Pair<Attribute, Processable<SimpleCorrespondence<MatchableValue>>>>> resultCollector) {
