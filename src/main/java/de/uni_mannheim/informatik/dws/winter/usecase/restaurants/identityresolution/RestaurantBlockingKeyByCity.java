...
public class RestaurantBlockingKeyByCity extends
	 ...
	 */
	@Override
	public void generateBlockingKeys(Restaurant record, Processable<SimpleCorrespondence<Attribute>> correspondences,
			DatasetIterator<Pair<String, Restaurant>> resultCollector) {
